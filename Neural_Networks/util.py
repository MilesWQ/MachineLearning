...
def load_data(dir, num_training=49000, num_validation=1000, num_test=1000, num_dev=500, bias=False, Normalization=False):
    """
    ...
    """
    preprocess data
    1. Mean substraction Normalization(optional)
